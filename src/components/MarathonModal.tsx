        ...
        <Stack>
          ...
          <PasswordInput
            ...
            onChange={(e) => {
              ...
              mantineForm.setFieldValue("pass", e.currentTarget.value);
            }}
            error={mantineForm.errors.pass}
          />
          <PasswordInput
            ...
            value={cfpass}
            onChange={(e) => {
              setCfpass(e.currentTarget.value);
              mantineForm.setFieldValue("cfpass", e.currentTarget.value);
            }}
            error={mantineForm.errors.cfpass}
          />
          <Select
            label="Plan"
